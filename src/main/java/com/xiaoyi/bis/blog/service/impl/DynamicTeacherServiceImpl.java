...
import com.xiaoyi.bis.blog.dao.DynamicTeacherMapper;
...
public class DynamicTeacherServiceImpl extends ServiceImpl<DynamicTeacherMapper, Dynamic> implements DynamicTeacherService {
...
//    }
    ...
    @Transactional
    @Deprecated
    public int releaseDynamic(String dynaId) {
        return this.baseMapper.releaseDynamic(dynaId);
    }
     ...
     */
    @Override
    public String saveTeacher(DynamicBean dynamicBean) {
...
//            dynamic.setUserId(dynamicBean.getUserId());
            ...
            dynamic.setDynaId(snowflakeIdGenerator.nextId() + "");
            dynamic.setDynaStatus(dynamicBean.getDynaStatus());
            dynamic.setDynaCheckSta(0);
            dynamic.setDynaContent(dynamicBean.getDynaContent());
            dynamic.setUserId(dynamicBean.getUserId());
            dynamic.setDynaType(1);
