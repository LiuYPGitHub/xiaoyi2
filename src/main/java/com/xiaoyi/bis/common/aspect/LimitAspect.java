...
import com.xiaoyi.bis.common.domain.LimitType;
import com.xiaoyi.bis.common.exception.LimitAccessException;
...
public class LimitAspect {
    ...
    @Pointcut("@annotation(com.xiaoyi.bis.common.annotation.Limit)")
