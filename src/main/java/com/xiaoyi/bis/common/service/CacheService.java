package com.xiaoyi.bis.common.service;
...
public interface CacheService {
     ...
     * @return LeadsUser
     */
    LeadsUser getSysUser(String telNun) throws Exception;
     ...
     * @param telNum 手机号
     */
    void saveSysUser(String telNum) throws Exception;
     ...
     * @param telNum 用户名
     */
    void deleteSysUser(String telNum) throws Exception;
