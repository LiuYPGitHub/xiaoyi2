package com.xiaoyi.bis.common.service.impl;
...
import com.xiaoyi.bis.system.dao.UserMapper;
import com.xiaoyi.bis.system.domain.*;
import com.xiaoyi.bis.system.service.MenuService;
import com.xiaoyi.bis.system.service.RoleService;
import com.xiaoyi.bis.system.service.UserConfigService;
...
public class CacheServiceImpl implements CacheService {
    ...
    @Autowired
    private LeadsUserMapper leadsUserMapper;
    ...
    @Override
    public LeadsUser getSysUser(String telNun) throws Exception {
        String userString = this.redisService.get(FebsConstant.USER_CACHE_PREFIX + telNun);
        if (StringUtils.isBlank(userString))
            return null;
        else
        return this.mapper.readValue(userString, LeadsUser.class);
    }

    @Override
    public void saveSysUser(String telNum) throws Exception {
        final LeadsUser leadsUserDetail = leadsUserMapper.findSysUserDetail(telNum);
        this.deleteUser(telNum);
        redisService.set(FebsConstant.USER_CACHE_PREFIX + telNum, mapper.writeValueAsString(leadsUserDetail));
    }

    @Override
    public void deleteSysUser(String telNum) throws Exception {
        redisService.del(FebsConstant.USER_CACHE_PREFIX + telNum);
    }
