package com.xiaoyi.bis.common.generator;
...
public class CodeGenerator {
    ...
    // 数据库 URL
    private static final String URL = "jdbc:mysql://127.0.0.1:3306/zcxy?useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
    // 数据库驱动
    ...
    // @author 值
    private static final String AUTHOR = "秋山";
    // 包的基础路径
    private static final String BASE_PACKAGE_URL = "com.xiaoyi.bis";
    // xml文件路径
