...
import com.xiaoyi.bis.common.function.CacheSelector;
...
public class FebsUtil {
 ...
 /*   public static User getCurrentUser() {
    ...
    public static LeadsUser getCurrentUser() {
        String token = (String) SecurityUtils.getSubject().getPrincipal();
        String username = JWTUtil.getUsername(token);
        final LeadsUserService leadsUserService = SpringContextUtil.getBean(LeadsUserService.class);
        CacheService cacheService = SpringContextUtil.getBean(CacheService.class);

        return selectCacheByTemplate(() -> cacheService.getSysUser(username), () -> leadsUserService.findByTel(username));
    }
